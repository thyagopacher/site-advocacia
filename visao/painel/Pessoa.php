...
if(isset($_GET["codnivel"])){
    if($_GET["codnivel"] == 1){
        $tipo = "funcionário";
    }elseif($_GET["codnivel"] == 2){
        $tipo = "cliente";
    }
    $pessoa["codnivel"] = $_GET["codnivel"];
}
?>
<!DOCTYPE html>
<!--
    ...
    <body>
        ...
        <form id="fpessoa" name="fpessoa">
            <fieldset>
                ...
                <input type="hidden" name="codnivel" id="codnivel" value="<?=$pessoa["codnivel"]?>"/>
                <p>
                    <label>Nome</label>
                ...
                <p>
                    <label>E-mail</label>
                    <input type="email" required name="email" id="email" size="50" maxlength="50" value="<?=$pessoa["email"]?>"/>
                </p>                     
                <p>
                    <label>Senha</label>
                    <input type="password" required name="senha" id="senha" size="50" maxlength="50" value="<?=$pessoa["senha"]?>"/>
                </p> 
                <p>
                    <label>Telefone</label>
                    <input type="text" required name="telefone" id="telefone" size="15" maxlength="11" value="<?=$pessoa["telefone"]?>"/>
                </p>                  
                <p>
                    <label>Celular</label>
                    <input type="text" required name="celular" id="celular" size="15" maxlength="11" value="<?=$pessoa["celular"]?>"/>
                </p>                  
                <p>
                    <label>CEP</label>
